...
module Setup
  ...
  NEW_HEADER = 'new'
  HOTLIST_HEADER = 'hot'
  CONTINUITY_HEADER = 'continuity'
  ALBUM_COLUMN_HEADERS = %W{artist album #{ALBUM_FAVOURITE_HEADER} #{NEW_HEADER} #{CONTINUITY_HEADER}}
  TRACK_COLUMN_HEADERS = %W{artist album track #{TRACK_FAVOURITE_HEADER} #{ESSENTIALS_HEADER} #{NEW_HEADER} #{HOTLIST_HEADER}}
  ...
  TRACK_HOTLIST_COLUMN_INDEX = TRACK_COLUMN_HEADERS.find_index HOTLIST_HEADER
  ...
  ALBUM_CONTINUITY_COLUMN_INDEX = ALBUM_COLUMN_HEADERS.find_index CONTINUITY_HEADER
